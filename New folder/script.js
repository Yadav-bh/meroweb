        ...
        toggle.addEventListener('click', function(e) {
            if (window.innerWidth <= 992) { // Mobile view
                ...
                if (!isActive) {
                    ...
                    // If clicking the same dropdown, navigate to the link
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Update active state for analysis section navigation
    const analysisLinks = document.querySelectorAll('.dropdown-menu a');
    const analysisSections = document.querySelectorAll('.analysis-features .feature-item');
    
    // Add click handlers for analysis navigation
    analysisLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            // Remove active class from all links
            analysisLinks.forEach(l => l.parentElement.classList.remove('active'));
